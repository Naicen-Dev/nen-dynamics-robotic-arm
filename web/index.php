		...
		<table border="0">
			<tr>
				...
				<br><form action="index.php" method="post">
					...
					rechts <input type="submit" onclick="handgelenk1(0.5)" value="+0.50">
					...
					<input type="submit" onclick="handgelenk1(-0.05)" value="-0.05">
					<input type="submit" onclick="handgelenk1(-0.5)" value="-0.50"> links
					<br><br>
				...
				<form action="index.php" method="post">
					<input type="hidden" name="motor1" value="1.55">
